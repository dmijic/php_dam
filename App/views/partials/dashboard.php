                ...
                <div class="card info-card sales-card">
                    ...
                    <div class="filter">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <li><a class="dropdown-item" href="/brand/<?= slugify($brand->id) ?>">Brend materijali</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center border">
                                <img src="<?= $brand->brand_logo_url ?>" class="card-img-top" alt="..." style="max-width: 50px; height: auto;">
                            </div>
                            <div class="ps-3">
                                <h6><?= productCount($products, $brand) ?></h6>
                                <span class="text-muted small pt-2 ps-1">proizvoda</span>
